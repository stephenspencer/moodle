...
/**
 * General layout for the hau_mobile theme
 *
 * @package    theme
...
// get blocks?
$toblock = optional_param('hau_mobile_blocks', false, PARAM_BOOL);
// get settings?
$toset = optional_param('hau_mobile_settings', false, PARAM_BOOL);
...
$urlblocks = new moodle_url($PAGE->url, array('hau_mobile_blocks' => 'true'));
$urlsettings = new moodle_url($PAGE->url, array('hau_mobile_settings' => 'true'));
...
if ($gowide) {
    ...
    hau_mobile_initialise_colpos($PAGE);
}
$usercol = (hau_mobile_get_colpos() == 'on');

$renderer = $PAGE->get_renderer('theme_hau_mobile');

echo $OUTPUT->doctype() ?>
<html id="hau_mobile" <?php echo $OUTPUT->htmlattributes() ?>>
<head>
...
<body id="<?php p($PAGE->bodyid) ?>" class="<?php p($PAGE->bodyclasses.' '.join(' ', $bodyclasses)) ?>">
    ...
    <div id="<?php p($PAGE->bodyid) ?>PAGE" data-role="page" class="generalpage <?php echo 'ajaxedclass '; p($PAGE->bodyclasses.' '.join(' ', $bodyclasses));  ?> <?php if ($hasmyblocks && $usercol) { echo 'has-myblocks'; } ?> " data-title="<?php p($SITE->shortname) ?>">
        <!-- start header -->
        <div id="page-header" data-role="header" <?php echo($datatheme);?> class="hau_mobileheader" data-position="fixed">
        ...
        <!-- main content -->
        <div data-role="content" class="hau_mobilecontent" <?php echo $databodytheme; ?>>
          ...
          <?php } ?>
            ...
            <div class="content-secondary">
                ...
                <div data-role="fieldcontain" id="sliderdiv">
                    <label for="slider"><?php p(get_string('mtoggle','theme_hau_mobile')); ?>:</label>
