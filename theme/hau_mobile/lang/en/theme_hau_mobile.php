...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>hau_mobile</h2><img src="hau_mobile/pix/screenshot.png" /><h2>About</h2><p>hau_mobile is a mobile theme for Moodle 2.x. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p></div></div>';
...
$string['no'] = 'No';
$string['pluginname'] = 'Harper Adams Mobile';
