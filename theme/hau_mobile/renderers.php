...
/**
 * Renderers for the hau_mobile theme
 *
 * @package    theme
...
/**
 * A custom renderer for the hau_mobile theme to produce snippets of content.
 *
 * @package    theme
 * @subpackage hau_mobile
 * @copyright  John Stabinger
...
class theme_hau_mobile_renderer extends plugin_renderer_base {
...
/**
 * Overridden core renderer for the hau_mobile theme
 *
 * @package    theme
 * @subpackage hau_mobile
 * @copyright  John Stabinger
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_hau_mobile_core_renderer extends core_renderer {
    ...
    public function block(block_contents $bc, $region) {
        ...
        $bc = clone($bc);
        // The hau_mobile theme does not support collapsible blocks.
    ...
    protected function init_block_hider_js(block_contents $bc) {
        // The hau_mobile theme in no shape or form supports the hiding of blocks
        // this function has been defined and left empty intentionally so that
        // the block hider JS is not even included.
    }

    /**
     * Produces the navigation bar for the hau_mobile theme
     *
     * @return string
     */
    ...
    protected function render_help_icon(help_icon $helpicon) {
        ...
        $url = new moodle_url('/help.php', array('component' => $helpicon->component, 'identifier' => $helpicon->identifier, 'lang'=>current_language(), 'theme'=>'hau_mobile'));
...
/**
 * Overridden choice module renderer for the hau_mobile theme
 *
 * @package    theme
 * @subpackage hau_mobile
 * @copyright  John Stabinger
...
if (file_exists($choice . '/renderer.php')) {
    require_once($CFG->dirroot . '/theme/hau_mobile/renderers/mod_choice_renderer.php');
}
